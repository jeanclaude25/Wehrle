...
import { Clone, useGLTF, Instances, Instance, useMatcapTexture, Text3D, Center } from "@react-three/drei";
import { useFrame } from "@react-three/fiber";

const textMaterial = new THREE.MeshMatcapMaterial()

const ObjectInstance = ({ Positions = [], object, Scales = [], Rotations = [], ...props }) =>{
  const Pos = Positions
  const Ob = object
  const Scal = Scales
